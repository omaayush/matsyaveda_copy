...
// Custom CSS Editor
function specia_custom_css_editor()
{?>
	<style type="text/css">
	<?php echo esc_attr( get_theme_mod('css_editor') ); ?>
	</style>
<?php }
add_action('wp_head','specia_custom_css_editor');



// Custom Script Editor
function specia_custom_script_editor()	{
	$script_editor = get_theme_mod('script_editor','');
	if($script_editor!='') {  ?>
		<script type="text/javascript">
		<?php echo $script_editor; ?>
		</script>
	<?php } 
	add_action('wp_footer','specia_custom_script_editor');
}

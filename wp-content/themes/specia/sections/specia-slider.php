<?php 
	...
	$slider_caption_align= get_theme_mod('slider_caption_align','text-left'); 
	...
	<section class="slider-version">
		...
		<div class="slider-version-one">
			...
			<div class="item">
				...
				<div class="specia-slider" style="background:<?php echo esc_attr($slider_overlay); ?>;">
					<div class="container inner-table">
						<div class="inner-table-cell">
							<div class="caption verticle-center <?php echo $slider_caption_align; ?>">

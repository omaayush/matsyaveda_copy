...
?>
<section class="call-to-action" style="background:url('<?php echo esc_url($call_action_background_setting); ?>') no-repeat <?php echo esc_attr($call_actions_background_position); ?>;">

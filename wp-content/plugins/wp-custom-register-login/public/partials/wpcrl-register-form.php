            ...
            if (!is_user_logged_in()) :
                ...
                <form name="wpcrlRegisterForm" id="wpcrlRegisterForm" method="post">
                    ...
                    <div class="form-group">
                        <label for="firstname"><?php _e('First name', $this->plugin_name); ?>
                        <sup class="wpcrl-required-asterisk">*</sup></label>
                    ...
                    <div class="form-group">
                        <label for="username"><?php _e('Username', $this->plugin_name); ?>
                        <sup class="wpcrl-required-asterisk">*</sup></label>
                        <input type="text" class="form-control" name="wpcrl_username" id="wpcrl_username" placeholder="Username">
                    </div>
                    <div class="form-group">
                        <label for="email"><?php _e('Email', $this->plugin_name); ?>
                        <sup class="wpcrl-required-asterisk">*</sup></label>
                        <input type="text" class="form-control" name="wpcrl_email" id="wpcrl_email" placeholder="Email">
                    </div>
                    <div class="form-group">
                        <label for="password"><?php _e('Password', $this->plugin_name); ?>
                        <sup class="wpcrl-required-asterisk">*</sup></label>
                        <input type="password" class="form-control" name="wpcrl_password" id="wpcrl_password" placeholder="Password" >
                    </div>
                    <div class="form-group">
                        <label for="confrim password"><?php _e('Confirm Password', $this->plugin_name); ?>
                        <sup class="wpcrl-required-asterisk">*</sup></label>
                    ...
                    <button type="submit" class="woocommerce-Button button">
                        ...
                        _e($submit_button_text, 'woocommerce');

                        ?></button>
                </form>
                </br>
                <p class="woocommerce-LostPassword lost_password">
                <a href="/?page_id=7"><?php _e( 'Login  ', 'woocommerce' ); ?> | </a> <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'woocommerce' ); ?></a>
            </p>
                <?php
            else:
